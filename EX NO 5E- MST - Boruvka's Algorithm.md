...
## Program:
```txt
Program to implement Minimum Spanning Tree using Boruvka's Algorithm
...
## Output:
<img width="633" height="516" alt="image" src="https://github.com/user-attachments/assets/977b66f3-341d-403b-aedf-fdbca88ad133" />
