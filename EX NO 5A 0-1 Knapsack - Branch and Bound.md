...
## Program:
```txt
Program to implement 0/1 Knapsack using Branch and Bound
...
## Output:
<img width="274" height="194" alt="image" src="https://github.com/user-attachments/assets/3ead40f4-2800-4e28-aae0-252a796b1ba6" />
